    ...
    return (
        <View style={styles.conatainer}>
            ...
            <View style={styles.resendView}> 
                    ...
                    > Resend</Text>
                    {count !==0 && (
                        <Text style={{fontSize:20,marginLeft:30}}>{count + 'seconds'}</Text>
                    )}
                    
            </View>
                    <TouchableOpacity disabled={
                        f1 !== '' && f2 !== '' && f3 !=='' && f4!== '' && f5!=='' && f6 !== '' ? false : true
                    } style={[styles.verifyOtpBtn, {backgroundColor: f1 !== '' && f2 !== '' && f3 !=='' && f4!== '' && f5!=='' && f6 !== '' ? 'blue' : '#e8e8e8'}]}
                    onPress={()=>{
                        otpValidate()
                    }}
                    >
<Text style={styles.btnTxt}> Verfiy OTP </Text>
                    </TouchableOpacity>
        </View>
    )
}
...
const styles = StyleSheet.create({
    ...
    resendView:{
        flexDirection:'row', alignSelf:'center', marginTop:20, marginBottom:10
    }
})